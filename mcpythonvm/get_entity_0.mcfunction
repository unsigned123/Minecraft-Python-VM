...
#LOAD_GLOBAL
data modify storage pvm:get_entity stack append value {"data":{"package_name":"pvm","callee_name":"exec","caller_name":"get_entity"},"type":"function","function":1}
data remove storage pvm:get_entity stack[-1].name
#LOAD_CONST
...
data remove storage pvm:get_entity stack[-1]
#LOAD_GLOBAL
data modify storage pvm:get_entity stack append value {"data":{"package_name":"pvm","callee_name":"getnbt_single","caller_name":"get_entity"},"type":"function","function":1}
data remove storage pvm:get_entity stack[-1].name
#LOAD_CONST
