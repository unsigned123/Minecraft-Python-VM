...
data modify storage pvm:str return set value {data:0,str:1,"type":"str"}
execute unless data storage pvm:argbuf buf[0].float run data modify storage pvm:str return.data set from storage pvm:to_str result
#to remove "d"
