...
def dis(x=None, *, file=None, depth=None, show_caches=False, adaptive=False):
    ...
    if hasattr(x, '__dict__'):  # Class or module
        ...
        return _disassemble_recursive(x, file=file, depth=depth, show_caches=show_caches, adaptive=adaptive)
    elif isinstance(x, (bytes, bytearray)): # Raw bytecode
        return _disassemble_bytes(x, file=file, show_caches=show_caches)
...
class Instruction(_Instruction):
    ...
    def _disassemble(self, lineno_width=3, mark_as_current=False, offset_width=4):
        ...
        *offset_width* sets the width of the instruction offset field
        ...
        fields.append(repr(self.offset))
        # Column: Opcode name
        fields.append(self.opname)
...
def disassemble(co, lasti=-1, *, file=None, show_caches=False, adaptive=False):
    ...
    return _disassemble_bytes(_get_code_array(co, adaptive),
...
def _disassemble_recursive(co, *, file=None, depth=None, show_caches=False, adaptive=False):
    result = []
    result.append(disassemble(co, file=file, show_caches=show_caches, adaptive=adaptive))
    if depth is None or depth > 0:
        ...
        for x in co.co_consts:
            if hasattr(x, 'co_code'):
                ...
                result.append(_disassemble_recursive(
...
def _disassemble_bytes(code, lasti=-1, varname_from_oparg=None,
    ...
    for instr in _get_instructions_bytes(code, varname_from_oparg, names,
        ...
        result = instr._disassemble(lineno_width, is_current_instr, offset_width)
        instructions.append([result[4],
                              result[5:],
                             result[3]])
